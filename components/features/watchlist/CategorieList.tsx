...
import { useFetchWatchList } from "../../../src/hooks/queries/useFetchWatchList";
            ...
            <div>
              ...
              <div className="m-4">
                ...
                {filmsSelection && filmsSelection.length > 0 ? (
                  <MediaTable data={filmsSelection} onModify={refetch} />
                ) : (
              ...
              <div className="m-4">
                ...
                {seriesSelection && seriesSelection.length > 0 ? (
                  <MediaTable data={seriesSelection} onModify={refetch} />
                ) : (
