...
export default function CategorieList() {
  ...
  const [filmsSelection, setFilmsSelection] = useState<MediaItem[]>();
  const [seriesSelection, setSeriesSelection] = useState<MediaItem[]>();
            ...
            <div>
              ...
              <div className="m-4">
                ...
                {filmsSelection && filmsSelection.length > 0 ? (
                  <MediaTable data={filmsSelection} type="FILM" />
                ) : (
              ...
              <div className="m-4">
                ...
                {seriesSelection && seriesSelection.length > 0 ? (
                  <MediaTable data={seriesSelection} type="SERIE" />
                ) : (
